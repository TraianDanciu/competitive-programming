...
- my solutions for some competitive programming problems (usually, in C++)
...
The editorial and the comments in my sources of the problems will sometimes be in Romanian (mostly for Romanian problems). If you want me to add an english editorial, add an issue.
